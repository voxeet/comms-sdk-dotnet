...
- Enter `https://github.com/DolbyIO/comms-sdk-unity.git`.
...
>1. Open **Terminal**.
>2. Assuming the name of your project is `myproject` under your home folder, run this command: 
`xattr -d -r com.apple.quarantine ~/myproject/Library/PackageCache/dolbyio.comms.unity*`.
