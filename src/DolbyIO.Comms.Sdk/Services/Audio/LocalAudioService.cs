...
{
    /// <summary>
    /// The local audio service allows <see cref="StartAsync">enabling</see>, <see cref="StopAsync">disabling</see>, and <see cref="MuteAsync(bool)">muting</see> the local participant's audio.
    /// </summary>
    /// <example>
    /// <code>
    /// try
