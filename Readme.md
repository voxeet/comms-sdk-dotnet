...
**NOTE:** The SDK is fully asynchronous, and all methods can throw the [DolbyIOException](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.DolbyIOException.html).
...
To open a new session, use the [Session.OpenAsync](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.Services.SessionService.html#DolbyIO_Comms_Services_SessionService_OpenAsync_DolbyIO_Comms_UserInfo_) method as in the following example:
...
To create and join a conference, use the [Conference.CreateAsync](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.Services.ConferenceService.html#DolbyIO_Comms_Services_ConferenceService_CreateAsync_DolbyIO_Comms_ConferenceOptions_) and [Conference.JoinAsync](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.Services.ConferenceService.html#DolbyIO_Comms_Services_ConferenceService_JoinAsync_DolbyIO_Comms_Conference_DolbyIO_Comms_JoinOptions_) methods as in the following example:
...
To leave the conference, use the [Conference.LeaveAsync](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.Services.ConferenceService.html#DolbyIO_Comms_Services_ConferenceService_LeaveAsync) method, as in the following example:
...
After leaving the conference, close the session and dispose the SDK using the [Session.CloseAsync](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.Services.SessionService.html#DolbyIO_Comms_Services_SessionService_CloseAsync) and [DolbyIOSDK.Dispose](https://dolbyio.github.io/comms-sdk-dotnet/api/DolbyIO.Comms.DolbyIOSDK.html#DolbyIO_Comms_DolbyIOSDK_Dispose) methods.
